...
import {Box, AppBar, CssBaseline, Button, Switch, Menu,
        Container, Typography, CardMedia, FormControlLabel, MenuItem, Toolbar} from '@mui/material';
                    ...
                    <Container maxWidth="lg" sx={{ display: 'flex', 
                        ...
                        <Box color="primary">                         
                                ...
                                {navItems.map((item) => (    
                                    ...
                                    <Button color="inherit" key={item.id} component={NavLink} 
                                                                          to={item.path}>                                       
